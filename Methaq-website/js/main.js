...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ==============================================
        const whyStatNumbers = whyChooseUsSection.querySelectorAll('.why-stat-number');
        ...
        const whyAnimateStats = function() {
            whyStatNumbers.forEach(stat => {
                ...
                const targetValue = parseFloat(originalText.replace('+', '').replace('%', ''));
        ...
        const whyAnimateCards = function() {
            const whyCards = whyChooseUsSection.querySelectorAll('.why-animate-fade-in');
        ...
        const whyAddHoverEffects = function() {
            const whyAdvantageCards = whyChooseUsSection.querySelectorAll('.why-advantage-card');
            const whyTrustItems = whyChooseUsSection.querySelectorAll('.why-trust-item');
        ...
        const whyCheckReducedMotion = function() {
            ...
            if (prefersReducedMotion.matches) {
                // Disable animations
                const whyAllAnimatedElements = whyChooseUsSection.querySelectorAll('.why-animate-fade-in, .why-advantage-card, .why-trust-item');
        ...
        window.matchMedia('(prefers-reduced-motion: reduce)').addEventListener('change', whyCheckReducedMotion);
        ...
        const whyOptimizePerformance = function() {
            ...
            const whyCards = whyChooseUsSection.querySelectorAll('.why-advantage-card, .why-trust-item');
            whyCards.forEach(card => {
        ...
        const whyHandleErrors = function() {
            try {
                ...
                if (!('IntersectionObserver' in window)) {
                    ...
                    console.warn('Intersection Observer not supported. Showing Section 5 animations immediately.');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initHoverEffects() {
        ...
        trustCards.forEach(card => {
            ...
            card.addEventListener('mouseleave', function() {
                this.style.transform = 'translateY(-5px) perspective(1000px) rotateX(0deg) rotateY(0deg)';
            });
        });
        
        // Add ripple effect to certification items
        const certItems = document.querySelectorAll('.certification-item, .guarantee-item');
    ...
    function initVisibilityObservers() {
        if ('IntersectionObserver' in window) {
            ...
            const icons = document.querySelectorAll('.card-icon i, .indicator-icon i');
